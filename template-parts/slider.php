...
<section id="featured-slider">
    ...
    <div id="main-banner">
        ...
        for ($i = 1; $i <= $slider_number; $i++) {
            $page_id = business_kit_get_option("slider_page_$i");
            if (absint($page_id) > 0) {
                    ...
                    <div class="<?php echo $overlay_class; ?>" style="background:url(<?php echo esc_url($slide_url); ?>) top center; background-size:cover;">
                        <div class="container">
                            <div class="caption">
                                ...
                                <?php
                                $slider_excerpt_length = business_kit_get_option('slider_excerpt_length');

                                $slider_excerpt = business_kit_get_the_excerpt(absint($slider_excerpt_length), $post);
                                ?>

                                <p><?php echo esc_html($slider_excerpt); ?></p>

                                <?php if (true === $slider_readmore_status && !empty($slider_readmore_text)) { ?>
