...
function business_kit_scripts() {
	...
	wp_enqueue_script( 'business-kit-custom', get_template_directory_uri() . '/assets/js/custom.js', array( 'jquery' ), '1.1.4', true );
...
function business_kit_admin_scripts( $hook ) {
	...
	if( 'widgets.php' === $hook ){
		...
		wp_enqueue_style( 'business-kit-admin', get_template_directory_uri() . '/includes/widgets/css/admin.css', array(), '1.1.4' );

		wp_enqueue_media();

		wp_enqueue_script( 'business-kit-admin', get_template_directory_uri() . '/includes/widgets/js/admin.js', array( 'jquery' ), '1.1.4' );
...
$args['rewrite']['slug'] = 'Attractions_Festivals';
$args['labels']['name'] = 'Attractions & Festivals';
}
